window.__require = function e(t, n, r) {
  ...
  phonictractor1_drag: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "2ea5epBYh9DEafASe7zAmTu", "phonictractor1_drag");
    "use strict";
    ...
    var PhonicTractor1Drag = function(_super) {
      __extends(PhonicTractor1Drag, _super);
      function PhonicTractor1Drag() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this._soundClip = null;
        return _this;
      }
      PhonicTractor1Drag.prototype.onLoad = function() {
        var _this = this;
        this.label.string = config_1.default.wide ? " " + this.node.name + " " : this.node.name;
        console.log("Util.loadsLetter(this.node.name.toLowerCase(), (clip) => {");
        util_1.Util.loadsLetter(this.node.name.toLowerCase(), function(clip) {
          null != clip && (_this._soundClip = clip);
        });
      };
      PhonicTractor1Drag.prototype.onTouchStart = function(touch) {
      ...
      PhonicTractor1Drag.prototype.onTouchEnd = function(touch) {
      ...
      __decorate([ error_handler_1.catchError() ], PhonicTractor1Drag.prototype, "onTouchEnd", null);
      PhonicTractor1Drag = __decorate([ ccclass ], PhonicTractor1Drag);
      return PhonicTractor1Drag;
    }(drag_1.default);
    exports.default = PhonicTractor1Drag;
    cc._RF.pop();
  }, {
  ...
  phonictractor1: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "0a0cdyAJB1HNJ7POhfVADgJ", "phonictractor1");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    var config_1 = require("../../../common/scripts/lib/config");
    var util_1 = require("../../../common/scripts/util");
    var phonictractor1_drag_1 = require("./phonictractor1_drag");
    var error_handler_1 = require("../../../common/scripts/lib/error-handler");
    var game_1 = require("../../../common/scripts/game");
    var drag_1 = require("../../../common/scripts/drag");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var PhonicTractor1 = function(_super) {
      __extends(PhonicTractor1, _super);
      function PhonicTractor1() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
      ...
      PhonicTractor1.prototype.onLoad = function() {
        var _this = this;
      ...
      PhonicTractor1.prototype.instantiateTrolley = function(i) {
      ...
      PhonicTractor1.prototype.showOptions = function() {
        var _this = this;
        ...
        for (var i = 0; i < this.count; i++) {
          ...
          var dragComp = dragBox.getComponent(phonictractor1_drag_1.default);
      ...
      PhonicTractor1.prototype.onTouchAudio = function(file) {
        var _this = this;
        util_1.Util.loadGameSound(file, function(clip) {
          null != clip && _this.friend.speak(clip);
        });
      };
      PhonicTractor1.prototype.onMatch = function() {
        var _this = this;
      ...
      PhonicTractor1.prototype.match = function() {
        --this.totalPieces <= 0 && this.node.emit("nextProblem");
      };
      PhonicTractor1.prototype.onDestroy = function() {
        cc.audioEngine.stopAllEffects();
      };
      __decorate([ property(cc.Node) ], PhonicTractor1.prototype, "truckNode", void 0);
      __decorate([ property(cc.Prefab) ], PhonicTractor1.prototype, "trolleyPrefab", void 0);
      __decorate([ property(cc.Prefab) ], PhonicTractor1.prototype, "boxPrefab", void 0);
      __decorate([ property({
        type: cc.AudioClip
      }) ], PhonicTractor1.prototype, "metalAudio", void 0);
      __decorate([ property({
        type: cc.AudioClip
      }) ], PhonicTractor1.prototype, "truckInAudio", void 0);
      __decorate([ property({
        type: cc.AudioClip
      }) ], PhonicTractor1.prototype, "truckOutAudio", void 0);
      __decorate([ error_handler_1.catchError() ], PhonicTractor1.prototype, "onLoad", null);
      __decorate([ error_handler_1.catchError() ], PhonicTractor1.prototype, "instantiateTrolley", null);
      __decorate([ error_handler_1.catchError() ], PhonicTractor1.prototype, "showOptions", null);
      __decorate([ error_handler_1.catchError() ], PhonicTractor1.prototype, "onTouchAudio", null);
      __decorate([ error_handler_1.catchError() ], PhonicTractor1.prototype, "onMatch", null);
      __decorate([ error_handler_1.catchError() ], PhonicTractor1.prototype, "match", null);
      __decorate([ error_handler_1.catchError() ], PhonicTractor1.prototype, "onDestroy", null);
      PhonicTractor1 = __decorate([ ccclass ], PhonicTractor1);
      return PhonicTractor1;
    }(game_1.default);
    exports.default = PhonicTractor1;
    cc._RF.pop();
  }, {
    "../../../common/scripts/drag": void 0,
    ...
    "../../../common/scripts/lib/error-handler": void 0,
    "../../../common/scripts/util": void 0,
    "./phonictractor1_drag": "phonictractor1_drag"
  } ]
}, {}, [ "phonictractor1", "phonictractor1_drag" ]);