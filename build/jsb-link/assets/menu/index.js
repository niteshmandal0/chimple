window.__require = function e(t, n, r) {
    ...
    var ChapterLessons = function(_super) {
      ...
      ChapterLessons.prototype.onLoad = function() {
        return __awaiter(this, void 0, void 0, function() {
          var config, _a, assignments, user, color;
          var _this = this;
          return __generator(this, function(_b) {
            switch (_b.label) {
             ...
             case 1:
              if (!profile_1.User.getCurrentUser().isConnected) return [ 3, 3 ];
             ...
             case 2:
              ...
              assignments = config.getAssignmentLessonsTodo();
              assignments.forEach(function(les) {
             ...
             case 7:
              ...
              color = HEADER_COLORS[config.course.id];
      ...
      ChapterLessons.prototype.createLessonButton = function(lesson, open) {
        ...
        lessonButtonComp.showScoreStars = ChapterLessons_1.showType !== ChapterLessonType.Assignments;
  ...
  dairyrewards: [ function(require, module, exports) {
    ...
    var DairyRewards = function(_super) {
      ...
      DairyRewards.prototype.onStoryReadingClick = function() {
        ...
        config_2.default.i.setRewardChapter("story");
        config_1.default.i.pushScene("menu/start/scenes/chapterLessons", "menu");
      };
  ...
  inventory: [ function(require, module, exports) {
    ...
    var Inventory = function(_super) {
      ...
      Inventory.prototype.onLoad = function() {
        ...
        var _a;
        try {
          null == Inventory_1.characterName && (Inventory_1.characterName = null !== (_a = profile_1.User.getCurrentUser().currentCharacter) && void 0 !== _a ? _a : "bear");
        } catch (err) {
        ...
        util_1.Util.loadFriend(function(friendNode) {
          var _a;
          friendNode.name = Inventory_1.characterName + "_dragon";
          friendNode.x = -270;
          friendNode.y = -212;
          console.log(_this.node, " hello ");
          null === (_a = _this.node) || void 0 === _a ? void 0 : _a.addChild(friendNode);
          util_1.Util.loadAccessoriesAndEquipAcc(friendNode.children[1], friendNode);
        }, Inventory_1.characterName);
      ...
      Inventory.prototype.buildIndividualItems = function(items) {
        ...
        items.forEach(function(element, index) {
          ...
          var rewardItemName = profile_1.User.getCurrentUser().unlockedRewards[util_1.REWARD_TYPES[3] + "-" + Inventory_1.characterName + "-" + element];
          ...
          itemComp.onClickCallback = function(name, isLocked) {
            ...
            if (isLocked) {
              profile_1.User.getCurrentUser().currentReward = [ util_1.REWARD_TYPES[3], Inventory_1.characterName, slot_name, armature_name ];
              config_1.default.i.popAllScenes();
              config_1.default.i.pushScene("menu/start/scenes/start", "menu", null, true);
            } else {
              Inventory_1.updateCharacter(_this.node.getChildByName(Inventory_1.characterName + "_dragon").children[0].getComponent(dragonBones.ArmatureDisplay), util_1.INVENTORY_ANIMATIONS[_this.lastSelectedButton], armature_name, slot_name);
              var characterAndSlot = Inventory_1.characterName.concat("-", slot_name);
  ...
  leaderboardProfile: [ function(require, module, exports) {
    ...
    var LeaderboardProfile = function(_super) {
          ...
          return __generator(this, function(_k) {
            switch (_k.label) {
             case 0:
              ...
              if (this.user.isConnected && mode != constants_1.Mode.Home) {
              ...
              profile_1.default.getValue(profile_1.CURRENTMODE) == constants_1.Mode.School && (this.connectButton.node.active = false);
              this.user.schoolName && this.user.isConnected && (this.schoolName.getComponent(cc.Label).string = util_1.Util.i18NText("School") + " : " + this.user.schoolName);
              this.user.sectionName && this.user.isConnected && (this.className.getComponent(cc.Label).string = util_1.Util.i18NText("Class  :") + " " + this.user.sectionName);
             ...
             case 1:
              _j.leaderboardJson = _k.sent();
              this.weeklyIndex = null !== (_d = null === (_c = null === (_b = null === (_a = this.leaderboardJson) || void 0 === _a ? void 0 : _a.weekly) || void 0 === _b ? void 0 : _b.map(function(v) {
                return v.userId;
              })) || void 0 === _c ? void 0 : _c.indexOf(this.user.id)) && void 0 !== _d ? _d : 0;
              this.allTimeIndex = null !== (_h = null === (_g = null === (_f = null === (_e = this.leaderboardJson) || void 0 === _e ? void 0 : _e.allTime) || void 0 === _f ? void 0 : _f.map(function(v) {
                return v.userId;
              })) || void 0 === _g ? void 0 : _g.indexOf(this.user.id)) && void 0 !== _h ? _h : 0;
              ...
              this.loadUi(true);
              this.hideLoading();
              (mode == constants_1.Mode.HomeConnect && !this.user.isConnected && !!this.user.schoolId || mode == constants_1.Mode.Home && this.user.isConnected) && (this.otpDialog.active = true);
              return [ 2 ];
            }
          });
        });
      ...
      LeaderboardProfile.prototype.loadUi = function(thisweek) {
        ...
        var studentList = thisweek ? null === (_a = this.leaderboardJson) || void 0 === _a ? void 0 : _a.weekly : null === (_b = this.leaderboardJson) || void 0 === _b ? void 0 : _b.allTime;
        ...
        var studentWidth = availableWidth / noOfColums - 10;
        for (var i = 0; i < (null === studentList || void 0 === studentList ? void 0 : studentList.length); i++) {
          var isCurrentUser = thisweek ? this.weeklyIndex === i : this.allTimeIndex === i;
          var totalScore = studentList[i].lessonsPlayed.toString();
          var maskedName = null !== (_d = null === (_c = studentList[i].name) || void 0 === _c ? void 0 : _c.trim()) && void 0 !== _d ? _d : "";
          if (isCurrentUser) {
            this.userNode.getChildByName("starscore").getComponentInChildren(cc.Label).string = totalScore;
            !(null === (_e = this.user) || void 0 === _e ? void 0 : _e.name) || (maskedName = this.user.name);
          } else try {
            var regexExp = /(\u00a9|\u00ae|[\u2000-\u3300]|\ud83c[\ud000-\udfff]|\ud83d[\ud000-\udfff]|\ud83e[\ud000-\udfff])/gi;
            if (regexExp.test(maskedName)) maskedName = "****"; else {
              var mask = "*".repeat(maskedName.length) || "***";
          ...
          if (0 === i) {
            ...
            if (isCurrentUser) {
              student_1.getChildByName("name").color = currentUserColor;
              student_1.getChildByName("bg").active = true;
            }
            student_1.width = studentWidth;
            this.loadRandomAvatar(student_1.getChildByName("user"), studentList[i].userId, isCurrentUser);
      ...
      LeaderboardProfile.prototype.tabNavigator = function(event, value) {
        return __awaiter(this, void 0, void 0, function() {
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              if (value === this.currentTab) return [ 2 ];
              this.showLoading();
      ...
      LeaderboardProfile.prototype.onLogoutButtonClick = function() {
        this.node.getChildByName("signout").getComponent(cc.Button).interactable = false;
        profile_1.User.setCurrentUser(null);
        config_1.default.i.popAllScenes();
        if (profile_1.default.getValue(profile_1.CURRENTMODE) == constants_1.Mode.School) null == cc.sys.localStorage.getItem(constants_1.IS_REMEMBER_TOGGLE_ON) || "false" === cc.sys.localStorage.getItem(constants_1.IS_REMEMBER_TOGGLE_ON) ? config_1.default.i.pushScene(landing_1.SECTION_LIST, "private", null) : config_1.default.i.pushScene("private/school/scenes/currentLoggedUser", "private", null); else {
          config_1.default.i.assignments = null;
      ...
      LeaderboardProfile.prototype.loadRandomAvatar = function(student, userId, isCurrentUser) {
        ...
        var randomInt;
        if (null != this.tempIcons[userId]) randomInt = this.tempIcons[userId]; else {
          randomInt = Math.floor(Math.random() * (cameraScene_1.AVATARS.length - 1 - 0 + 1) + 0);
      ...
      LeaderboardProfile.prototype.loadUserImageOrAvatar = function(user, userNode) {
        user && user.studentId && "" != user.studentId && user.studentId.length > 0 && null == user.avatarImage ? ParseImageDownloader_1.ParseImageDownloader.loadImageForSchool(user.imgPath, user.studentId, function(texture) {
          if (!!texture && userNode) {
            var spriteFrame = new cc.SpriteFrame(texture);
            var maskNode = userNode.getChildByName("mask");
            if (maskNode) {
              var image = maskNode.getChildByName("image");
              image.getComponent(cc.Sprite).spriteFrame = spriteFrame;
            }
          }
        }) : user && user.avatarImage && user.avatarImage.length > 0 && cc.resources.load("avatars/" + user.avatarImage, function(err, sp) {
          err || (userNode.getComponent(cc.Sprite).spriteFrame = new cc.SpriteFrame(sp));
        });
      };
      ...
      LessonButton.prototype.onLoad = function() {
        ...
        if (null != this.lesson && null != this.lesson.chapter.course && null != this.lesson) {
          ...
          if (null !== this.lesson.assignmentId && void 0 !== this.lesson.assignmentId) {
            if (this.open && this.showScoreStars && lessonProgress && lessonProgress.score >= 0) {
  ...
  profileOtpDialog: [ function(require, module, exports) {
      ...
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
          try {
            ...
            if (!schoolInfo) ProfileOtpDialog.showError("Something Went Wrong, Please Try Again"); else {
      ...
      return __awaiter(this, void 0, void 0, function() {
        return __generator(this, function(_a) {
          try {
            ...
            util_logger_1.default.processLoginFail();
            null === ProfileOtpDialog || void 0 === ProfileOtpDialog ? void 0 : ProfileOtpDialog.showError("Something Went Wrong, Please Try Again");
          } catch (error) {
    ...
    var ProfileOtpDialog = function(_super) {
      ...
      ProfileOtpDialog_1 = ProfileOtpDialog;
      ProfileOtpDialog.prototype.onLoad = function() {
        var _a;
        ProfileOtpDialog_1.node = this.node;
        ProfileOtpDialog_1.newconfirmBtn = this.confirmBtn;
        ProfileOtpDialog_1.newErrLabel = this.errLabel;
        ProfileOtpDialog_1.newconfirmBtn.interactable = false;
        ProfileOtpDialog_1.newClassName = this.className;
        ProfileOtpDialog_1.newParentNode = this.parentNode;
        ProfileOtpDialog_1.newSchoolName = this.schoolName;
        ProfileOtpDialog_1.newNode = this.node;
        this.createLoading();
        this.setDefaultText();
        this.editBox.enabled = true;
        this.editBox.string = "";
        this.dialingCode = null !== (_a = profile_1.default.getValue(profile_1.DIALING_CODE)) && void 0 !== _a ? _a : "+91";
      ...
      ProfileOtpDialog.prototype.onPhoneEditBegan = function() {
        this.setPlaceholder();
        this.contactEditBox.placeholderLabel.string = "";
      };
      ProfileOtpDialog.prototype.setDefaultText = function() {
        this.title.string = util_1.Util.i18NText("Please enter the details shared by your teacher below:");
        this.btnLabel.string = util_1.Util.i18NText("Confirm");
        ProfileOtpDialog_1.newErrLabel.string = "";
        this.setPlaceholder();
      };
      ProfileOtpDialog.prototype.setPlaceholder = function() {
        this.editBox.placeholderLabel.string = !this.editBox.string ? util_1.Util.i18NText("Enter the class code here") : "";
        this.contactEditBox.placeholderLabel.string = !this.contactEditBox.string ? util_1.Util.i18NText("Enter Student ID here") : "";
      };
      ProfileOtpDialog.prototype.onTextChanged = function() {
        var otp = this.editBox.string;
        var phoneNumber = this.contactEditBox.string;
        6 === otp.length && phoneNumber.length > 3 ? ProfileOtpDialog_1.newconfirmBtn.interactable = true : ProfileOtpDialog_1.newconfirmBtn.interactable = false;
      };
      ProfileOtpDialog.prototype.onOtpClose = function() {
        this.node.active = false;
        this.setDefaultText();
        null === ProfileOtpDialog_1 || void 0 === ProfileOtpDialog_1 ? void 0 : ProfileOtpDialog_1.hideLoading();
      };
      ProfileOtpDialog.prototype.createLoading = function() {
        ProfileOtpDialog_1.loading = cc.instantiate(this.loadingPrefab);
        ProfileOtpDialog_1.loading.zIndex = 3;
        ProfileOtpDialog_1.node.addChild(ProfileOtpDialog_1.loading);
        ProfileOtpDialog_1.loading.active = false;
      };
      ProfileOtpDialog.prototype.showLoading = function() {
        ProfileOtpDialog_1.loading.active = true;
        ProfileOtpDialog_1.node.parent.getChildByName("block").active = true;
      };
      ProfileOtpDialog.hideLoading = function() {
        ProfileOtpDialog_1.loading.active = false;
        ProfileOtpDialog_1.node.parent.getChildByName("block").active = false;
      };
      ProfileOtpDialog.prototype.onSendLinkStudentRequest = function() {
        return __awaiter(this, void 0, void 0, function() {
          var user, studentId, phoneNumber, isSecondProfile, _a, e_1, errCode, errJson, errorMessage;
          return __generator(this, function(_b) {
            switch (_b.label) {
             case 0:
              user = profile_1.User.getCurrentUser();
              studentId = user.id;
              ProfileOtpDialog_1.otpCode = this.editBox.string;
              phoneNumber = this.contactEditBox.string;
              if (!(!!studentId && !!ProfileOtpDialog_1.otpCode)) return [ 3, 4 ];
              ProfileOtpDialog_1.newconfirmBtn.interactable = false;
              ProfileOtpDialog_1.newErrLabel.string = "";
              this.showLoading();
              _b.label = 1;
             ...
             case 1:
              _b.trys.push([ 1, 3, , 4 ]);
              isSecondProfile = this.isSecondConnectedProfile();
              cc.log("getting custom auth...", ProfileOtpDialog_1.otpCode, phoneNumber, studentId);
              _a = ProfileOtpDialog_1;
              return [ 4, ServiceConfig_1.ServiceConfig.getI().handle.customAuth(ProfileOtpDialog_1.otpCode, phoneNumber, studentId, isSecondProfile, this.oldSchoolId, user.name, profile_1.default.getValue(profile_1.DIALING_CODE), user.age, user.gender) ];

             case 2:
              _a.customAuthInfo = _b.sent();
              cc.log("custom auth", ProfileOtpDialog_1.customAuthInfo);
              isSecondProfile ? ProfileOtpDialog_1.onLoginSuccess() : this.login(ProfileOtpDialog_1.customAuthInfo.email, ProfileOtpDialog_1.otpCode);
              return [ 3, 4 ];
             ...
             case 3:
              ...
              ProfileOtpDialog_1.showError(errorMessage);
              return [ 3, 4 ];
      ...
      ProfileOtpDialog.showError = function(error) {
        try {
          null === ProfileOtpDialog_1 || void 0 === ProfileOtpDialog_1 ? void 0 : ProfileOtpDialog_1.hideLoading();
          !ProfileOtpDialog_1.newErrLabel || (ProfileOtpDialog_1.newErrLabel.string = null === util_1.Util || void 0 === util_1.Util ? void 0 : util_1.Util.i18NText(error));
          !ProfileOtpDialog_1.newconfirmBtn || (ProfileOtpDialog_1.newconfirmBtn.interactable = true);
        } catch (error) {
          cc.log("error", error);
        }
      };
      ProfileOtpDialog.prototype.login = function(email, password) {
        return __awaiter(this, void 0, void 0, function() {
          return __generator(this, function(_a) {
            if (util_logger_1.default.isNetworkAvailable()) util_logger_1.default.login(email, password); else {
              ProfileOtpDialog_1.showError("Something Went Wrong, Please Try Again");
      ...
      ProfileOtpDialog.prototype.isSecondConnectedProfile = function() {
        if (profile_1.User.getUsers().length <= 1) return false;
        for (var _i = 0, _a = profile_1.User.getUsers(); _i < _a.length; _i++) {
          var usr = _a[_i];
      ...
      ProfileOtpDialog.onLoginSuccess = function() {
        try {
          profile_1.default.setItem(profile_1.CURRENTMODE, constants_1.Mode.HomeConnect);
          util_logger_1.default.processNewLinkStudent(ProfileOtpDialog_1.customAuthInfo, ProfileOtpDialog_1.otpCode);
          var s = ProfileOtpDialog_1.customAuthInfo.schoolName ? ProfileOtpDialog_1.customAuthInfo.schoolName : "";
          var sec = ProfileOtpDialog_1.customAuthInfo.sectionName ? ProfileOtpDialog_1.customAuthInfo.sectionName : "";
          ProfileOtpDialog_1.newParentNode.getComponentInChildren(cc.Label).string = util_1.Util.i18NText("Connected");
          ProfileOtpDialog_1.newParentNode.node.color = new cc.Color(240, 88, 34);
          s && (ProfileOtpDialog_1.newSchoolName.getComponent(cc.Label).string = util_1.Util.i18NText("School") + " : " + s);
          sec && (ProfileOtpDialog_1.newClassName.getComponent(cc.Label).string = util_1.Util.i18NText("Class  :") + " " + sec);
          ProfileOtpDialog_1.hideLoading();
          ProfileOtpDialog_1.newParentNode.interactable = false;
          ProfileOtpDialog_1.newNode.active = false;
        } catch (error) {
          ProfileOtpDialog_1.showError("Something Went Wrong, Please Try Again");
          cc.log(error);
        }
      };
      var ProfileOtpDialog_1;
      ProfileOtpDialog.loading = null;
      ...
      __decorate([ property(cc.EditBox) ], ProfileOtpDialog.prototype, "contactEditBox", void 0);
      __decorate([ property(cc.Prefab) ], ProfileOtpDialog.prototype, "loadingPrefab", void 0);
      __decorate([ error_handler_1.default() ], ProfileOtpDialog.prototype, "onLoad", null);
      ProfileOtpDialog = ProfileOtpDialog_1 = __decorate([ ccclass ], ProfileOtpDialog);
  ...
  rewards: [ function(require, module, exports) {
    ...
    var Rewards = function(_super) {
      ...
      Rewards.prototype.onLoad = function() {
        ...
        if (Rewards_1.contentDecisionFlag) {
          switch (Rewards_1.contentDecisionFlag) {
           case "0":
            this.node.getChildByName("Rewards label").getComponent(cc.Label).string = util_1.Util.i18NText("Character Modification");
            break;

           case "1":
            this.node.getChildByName("Rewards label").getComponent(cc.Label).string = util_1.Util.i18NText("Background Collection");
            break;

           case "2":
            this.node.getChildByName("Rewards label").getComponent(cc.Label).string = util_1.Util.i18NText("Badges Collection");
          }
      ...
      Rewards.prototype.onCharacterClick = function(event, customEventData) {
        ...
        event.currentTarget.getChildByName("tick").active = true;
        event.currentTarget.getChildByName("edit").active = true;
        if (profile_1.User.getCurrentUser().currentCharacter === customEventData.toString().trim()) {
          inventory_1.default.characterName = customEventData.toString().trim();
          config_1.default.getInstance().pushScene("menu/inventory/scenes/inventory", "menu");
        }
        inventory_1.default.characterName = customEventData.toString().trim();
        profile_1.User.getCurrentUser().currentCharacter = customEventData.toString().trim();
      ...
      Rewards.prototype.onBgClick = function(event, customEventData) {
        ...
        this.lastSelectedButton = parseInt(event.currentTarget.name);
        profile_1.User.getCurrentUser().currentBg = customEventData.toString().trim();
        util_1.Util.setBackground(customEventData.toString().trim(), this.bgHolder);
        var numberOfChildren = this.layoutHolder.children[1].children[0].children[0].children[0].childrenCount;
        for (var i = 0; i < numberOfChildren; i++) {
          var eachElement = this.layoutHolder.children[1].children[0].children[0].children[0].children[i];
          eachElement.getChildByName("tick").active = false;
      ...
      __decorate([ property(cc.Node) ], Rewards.prototype, "bgHolder", void 0);
    ...
    "../../../common/scripts/util": void 0,
    "../../../private/school/scripts/landing": void 0,
    "../../inventory/scripts/inventory": "inventory"
  } ],
  ...
  start: [ function(require, module, exports) {
    ...
    var Start = function(_super) {
      ...
      Start.prototype.start = function() {
        return __awaiter(this, void 0, void 0, function() {
          var config, mode, user, headerNode, headerComp, dataStr, data;
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              config = config_1.default.i;
             ...
             case 3:
              ...
              if (config_1.default.isMicroLink) {
                dataStr = cc.sys.localStorage.getItem(chimple_1.MICROLINK);
    ...
    "../../../common/scripts/util-logger": void 0,
    "../../inventory/scripts/inventory": "inventory",
    "../../rewards/scripts/rewards": "rewards",
