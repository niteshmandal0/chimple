window.__require = function e(t, n, r) {
          ...
          return __generator(this, function(_b) {
            switch (_b.label) {
             case 0:
              ...
              _a = selectedMode;
              switch (_a) {
               case constants_1.Mode.HomeConnect:
  ...
  secondscreen: [ function(require, module, exports) {
    ...
    var HOT_UPDATE_SERVER_ERR = "Invalid Hot Update Server";
    var SecondScreen = function(_super) {
      ...
      SecondScreen.prototype.makeUsers = function() {
        ...
        profile_1.User.getUsers().forEach(function(e, index) {
          ...
          e.debug && (_this.isDebugUser = true);
        });
      ...
      SecondScreen.prototype.initializeProfileData = function() {
        ...
        this.settingNode.getChildByName("hot_update").getComponentInChildren(cc.EditBox).string = null !== (_a = profile_1.default.getValue(constants_1.CUSTOM_HOT_UPDATE_SERVER)) && void 0 !== _a ? _a : constants_1.PROD_HOT_UPDATE_SERVER;
        this.settingNode.getChildByName("hot_update").getChildByName("version").getChildByName("label").getComponent(cc.Label).string = util_1.Util.getCurrentHotUpdateVersion().toString();
      };
      ...
      SecondScreen.prototype.onClickHotUpdate = function() {
        var _a;
        return __awaiter(this, void 0, void 0, function() {
          var errorLabel, hotUpdateServerUrl, updateButton, updateButtonlabel, result, error_1;
          return __generator(this, function(_b) {
            switch (_b.label) {
             case 0:
              errorLabel = this.settingNode.getChildByName("hot_update").getChildByName("notifier").getChildByName("url").getComponent(cc.Label);
              hotUpdateServerUrl = null === (_a = this.settingNode.getChildByName("hot_update").getComponentInChildren(cc.EditBox).string) || void 0 === _a ? void 0 : _a.trim();
              ...
              errorLabel.string = "";
              "/" !== hotUpdateServerUrl[hotUpdateServerUrl.length - 1] && (hotUpdateServerUrl += "/");
              updateButton = this.settingNode.getChildByName("hot_update").getComponentInChildren(cc.Button);
              updateButton.interactable = false;
              updateButtonlabel = updateButton.getComponentInChildren(cc.Label);
             ...
             case 1:
              ...
              return [ 4, new Promise(function(resolve, reject) {
                ...
                var requestUrl = hotUpdateServerUrl + "version.manifest";
             ...
             case 4:
              ...
              util_1.Util.changeHotUpdateServer(hotUpdateServerUrl);
              return [ 2 ];
            }
          });
        });
    ...
    var WelcomePage = function(_super) {
      ...
      WelcomePage.prototype.selectModes = function() {
        ...
        switch (modes) {
         ...
         case constants_1.Mode.HomeConnect:
         case constants_1.Mode.Home:
          !this.parentButtonPrefab || (this.parentButtonNode = cc.instantiate(this.parentButtonPrefab));
          var bg = null === (_a = this.parentButtonNode) || void 0 === _a ? void 0 : _a.getChildByName("Background");
          if (bg) {
            var label = bg.getChildByName("Label");
            var chimpleLabelComponent = label.getComponent(chimple_label_1.default);
            chimpleLabelComponent.string = util_1.Util.i18NText("Parent");
          }
          null === (_b = this.parentOrSettingNode) || void 0 === _b ? void 0 : _b.addChild(this.parentButtonNode);
          break;

         case constants_1.Mode.None:
          if (!!this.schoolButtonPrefab) {
            this.schoolButtonNode = cc.instantiate(this.schoolButtonPrefab);
            null === (_c = this.parentOrSettingNode) || void 0 === _c ? void 0 : _c.addChild(this.schoolButtonNode);
          }
          break;
         ...
         default:
          if (!!this.schoolButtonPrefab) {
            this.schoolButtonNode = cc.instantiate(this.schoolButtonPrefab);
            null === (_d = this.parentOrSettingNode) || void 0 === _d ? void 0 : _d.addChild(this.schoolButtonNode);
          }
        }
      };
      WelcomePage.prototype.layoutManager = function() {
        ...
        try {
          ...
          if (0 == WelcomePage_1.userArr.length) {
            var addBtn = void 0;
            !this.addButton || (addBtn = cc.instantiate(this.addButton));
            if (!!this.node) {
          ...
          filteredUsers.forEach(function(e) {
            ...
            cc.log(e);
            var userButtonRef;
            !_this.userButton || (userButtonRef = cc.instantiate(_this.userButton));
            if (!!userButtonRef) {
              ...
              cc.resources.load("avatars/" + e.avatarImage, function(err, sp) {
                try {
                  err || (userButtonRef.getChildByName("Background").getChildByName("avatar").getChildByName("icon").getComponent(cc.Sprite).spriteFrame = new cc.SpriteFrame(sp));
                } catch (error) {
                  cc.log("error in welcome page load avatars", error);
                }
              });
              userButtonRef.name = e.id;
              null === (_a = _this.node) || void 0 === _a ? void 0 : _a.getChildByName("userLayout").addChild(userButtonRef);
            }
          });
