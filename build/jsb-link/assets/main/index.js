window.__require = function e(t, n, r) {
  ...
  ApiHandler: [ function(require, module, exports) {
    ...
    var ApiHandler = function() {
      ...
      ApiHandler.prototype.customAuth = function(code, phoneNumber, progressId, isSecondProfile, schoolId, name, countryCode, age, gender) {
        return __awaiter(this, void 0, Promise, function() {
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              return [ 4, this.s.customAuth(code, phoneNumber, progressId, isSecondProfile, schoolId, name, countryCode, age, gender) ];
  ...
  FirebaseApi: [ function(require, module, exports) {
    ...
    var FirebaseApi = function() {
        ...
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
             ...
             case 1:
              jsonResult = _a.sent() || [];
              if (mode != constants_1.Mode.HomeConnect) if (!!jsonResult && "link" in jsonResult && !jsonResult.link) {
                user = profile_1.User.getCurrentUser();
                if (null != user) {
              ...
              } else if (!!jsonResult.studentId && mode != constants_1.Mode.School && mode != constants_1.Mode.HomeConnect) {
      ...
      FirebaseApi.prototype.customAuth = function(code, phoneNumber, progressId, isSecondProfile, schoolId, name, countryCode, age, gender) {
        return __awaiter(this, void 0, Promise, function() {
          var sendCode, requestParams, response, result;
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              if (!(progressId && progressId.length > 0 && code && code.length > 0)) return [ 3, 2 ];
              sendCode = Number(code);
              requestParams = {
                url: parseConstants_1.FIREBASE_CUSTOM_AUTH_URL,
                body: {
                  ...
                  name: name,
                  countryCode: countryCode,
                  gender: gender === profile_1.Gender.BOY ? "male" : gender === profile_1.Gender.GIRL ? "female" : null
                }
              };
  ...
  Utility: [ function(require, module, exports) {
    ...
    var marathiVowelList = [ "\u0905", "\u0906", "\u0907", "\u0908", "\u0909", "\u090a", "\u090f", "\u0910", "\u0913", "\u0914", "\u0905\u0902", "\u0905\u0903" ];
    var marathiConsonantList = [ "\u0915", "\u0916", "\u0917", "\u0918", "\u0918", "\u091a", "\u091b", "\u091c", "\u091d", "\u091e", "\u091f", "\u0920", "\u0921", "\u0922", "\u0923", "\u0924", "\u0925", "\u0926", "\u0927", "\u0928", "\u092a", "\u092b", "\u092c", "\u092d", "\u092e", "\u092f", "\u0930", "\u0932", "\u0935", "\u0936", "\u0937", "\u0938", "\u0939", "\u0933", "\u0915\u094d", "\u0937", "\u091c\u094d\u091e" ];
    var langMap = {
  ...
  chimple: [ function(require, module, exports) {
          ...
          if (elements && 2 === elements.length) {
            ...
            if (messageType.includes(exports.RECEIVED_TEACHER_REQUEST) || messageType.includes(exports.MICROLINK)) {
              ...
              if (messageType.includes(exports.MICROLINK)) {
                ...
                "chimple" !== cc.director.getScene().name && "welcomePage" !== cc.director.getScene().name && Chimple.selectModes();
              }
              try {
    ...
    var Chimple = function(_super) {
      ...
      Chimple.prototype.onLoad = function() {
        return __awaiter(this, void 0, void 0, function() {
          var assetManifestVersion, lang, langConfig, teachersAdded, updates, subpackages, doRestart;
          return __generator(this, function(_a) {
            cc.sys.isNative && jsb.fileUtils.setSearchPaths([ jsb.fileUtils.getWritablePath() + "HotUpdateSearchPaths", "@assets/" ]);
            assetManifestVersion = JSON.parse(this.manifest["_$nativeAsset"]).version;
            cc.log("assetManifestVersion: ", assetManifestVersion);
            profile_1.default.setItem(constants_1.ASSET_MANIFEST_VERSION, assetManifestVersion);
            ...
            this.oneByOne(updates, 0, function(index, restart) {
              ...
              if (index == updates.length - 1) if (doRestart) {
                ...
                cc.game.restart();
              } else Chimple_1.selectModes();
            });
            return [ 2 ];
          });
        });
      };
      Chimple.selectModes = function() {
      ...
      Chimple.prototype.oneByOne = function(updates, index, callbackOnEnd) {
        var _this = this;
        var manifestString;
        var serverUrl = profile_1.default.getValue(constants_1.CUSTOM_HOT_UPDATE_SERVER);
        cc.log("server Url", serverUrl);
        if (serverUrl) try {
          var manifestJson = JSON.parse(updates[index].manifest["_$nativeAsset"]);
        ...
        Chimple_1.doHotUpdate(updates[index].storagePath, updates[index].manifest.nativeUrl, manifestString, function(event, status, percent) {
      ...
      Chimple.doHotUpdate = function(storagePath, manifestUrl, manifestJson, callback) {
        ...
        if (am.getState() === jsb.AssetsManager.State.UNINITED) if (manifestJson) {
      ...
      Config.continueLoadScene = function(scene, bundle, callback) {
        ...
        if (null != bundle) {
          util_logger_1.default.logChimpleEvent("load_scene", {
            scene: "common/scenes/lessonController" == scene ? scene + " " + Config.i.lesson.id : scene,
            bundle: bundle
          });
  ...
  constants: [ function(require, module, exports) {
    ...
    (function(Mode) {
      ...
      Mode[Mode["HomeConnect"] = 5] = "HomeConnect";
    ...
    exports.PROD_HOT_UPDATE_SERVER = "https://bahama-stage.web.app/v2/hot-update/";
    exports.CUSTOM_HOT_UPDATE_SERVER = "custom_hot_update_server";
    exports.ASSET_MANIFEST_VERSION = "asset_manifest_version";
    cc._RF.pop();
  }, {} ],
              ...
              if (user) {
                ...
                switch (ServiceConfig_1.ServiceConfig.getI().mode) {
                 case ServiceConfig_1.APIMode.FIREBASE:
                  ...
                  mode = parseInt(profile_1.default.getValue(profile_1.CURRENTMODE));
                  mode === constants_1.Mode.School || mode === constants_1.Mode.HomeConnect ? (mode === constants_1.Mode.School || user.isConnected) && util_logger_1.default.historyProgress(updateInfo.chapter, updateInfo.chapterName, updateInfo.lesson, updateInfo.lessonName, profile_1.User.getCurrentUser().id, profile_1.User.getCurrentUser().schoolId, profile_1.User.getCurrentUser().sectionId, updateInfo.courseName, "" + updateInfo.assessment, config.lesson.assignmentId, profile_1.User.getCurrentUser().name, timeSpent.toString()) : queue_1.Queue.getInstance().push(updateInfo);
                  break;
  ...
  lessonIcon: [ function(require, module, exports) {
    ...
    var LessonIcon = function(_super) {
      ...
      LessonIcon.prototype.onLoad = function() {
        ...
        if (this.open || constants_1.ALL_OPEN) {
  ...
  parseApi: [ function(require, module, exports) {
    ...
    var ParseApi = function() {
      ...
      ParseApi.prototype.customAuth = function(code, phoneNumber, progressId, isSecondProfile, schoolId, name, countryCode, age, gender) {
        return __awaiter(this, void 0, Promise, function() {
          return __generator(this, function(_a) {
            return [ 2, null ];
          });
  ...
  parseConstants: [ function(require, module, exports) {
    ...
    exports.FIREBASE_CUSTOM_AUTH_URL = "https://us-central1-bahama-stage.cloudfunctions.net/chimple/customAuth";
  ...
  profile: [ function(require, module, exports) {
    ...
    var User = function() {
      function User(id, name, age, gender, imgPath, avatarImage, isTeacher, inventory, currentBg, currentCharacter, courseProgressMap, lessonProgressMap, chapterFinishedMap, unlockedInventory, unlockedRewards, debug, lessonPlan, serverId, schoolId, sectionId, studentId, schoolName, sectionName, currentReward, last5Lessons) {
        ...
        void 0 === last5Lessons && (last5Lessons = new Map());
      ...
      Object.defineProperty(User.prototype, "unlockedInventory", {
        ...
        set: function(unlockedInventory) {
          this._unlockedInventory = null !== unlockedInventory && void 0 !== unlockedInventory ? unlockedInventory : {};
          this.storeUser();
        },
        enumerable: false,
        configurable: true
      ...
      Object.defineProperty(User.prototype, "unlockedRewards", {
        ...
        set: function(unlockedRewards) {
          this._unlockedRewards = null !== unlockedRewards && void 0 !== unlockedRewards ? unlockedRewards : {};
          this.storeUser();
        },
        enumerable: false,
        configurable: true
      ...
      Object.defineProperty(User.prototype, "last5Lessons", {
        get: function() {
      ...
      User.prototype.updateLast5Lessons = function(item) {
        var _a;
        var config = config_1.default.i;
        var course = config.course.id;
        var last5Lessons = null !== (_a = this._last5Lessons.get(course)) && void 0 !== _a ? _a : [];
      ...
      User.prototype.openAllRewards = function() {
        ...
        util_1.STICKER_REWARDS.forEach(function(arr) {
      ...
      User.prototype.updateLessonProgress = function(lessonId, score, quizScores, assignmentId) {
        ...
        if (cpm) {
          if (this._lessonProgressMap.has(lessonId)) {
            ...
            if (score > (null !== (_a = lessonProgress.score) && void 0 !== _a ? _a : 0)) {
          ...
          if (lessonPlan && lessonPlan[cpm.lessonPlanIndex] == config.lesson.id) {
            ...
            if (config_1.default.i.lesson.type != constants_1.EXAM || score >= constants_1.MIN_PASS) {
              ...
              if (lessons.length > lessonIndex + 1) {
                ...
                if (config_1.default.i.course.chapters[config_1.default.i.course.chapters.length - 1].id == config_1.default.i.chapter.id || true === this.courseProgressMap.get(config_1.default.i.course.id).isCourseCompleted) {
                  var randomInt = Math.floor(Math.random() * (config_1.default.i.course.chapters.length - 1 - 1 + 1) + 0);
                  nextChapter = config_1.default.i.course.chapters[randomInt];
                  this.courseProgressMap.get(config_1.default.i.course.id).isCourseCompleted = true;
                }
                if (!nextChapter) {
                  var found = false;
                  nextChapter = config_1.default.i.course.chapters.find(function(c) {
      ...
      User.syncProfile = function() {
        ...
        var mode = parseInt(Profile.getValue(exports.CURRENTMODE));
        if (cc.sys.isNative && !!user && !!user.schoolId && !!user.sectionId && !!user.studentId && !!user.id) {
          if (!(null === user || void 0 === user ? void 0 : user.isConnected) && mode === constants_1.Mode.HomeConnect) return;
          util_logger_1.default.syncProfile(user.schoolId, user.sectionId, user.studentId, User.toJson(user), user.id);
        }
      };
      ...
      User.fromJson = function(jsonStr) {
        ...
        var last5Lessons = new Map();
        if (data.last5Lessons) for (var key in data.last5Lessons) {
          var last5LessonsItems = [];
          for (var _i = 0, _a = data.last5Lessons[key]; _i < _a.length; _i++) {
            var item = _a[_i];
            var last5LessonsItem = {
              lesson: item.lesson,
              score: item.score,
              date: item.date
            };
        ...
        var user = new User(data.id, data.name, data.age, data.gender, data.imgPath, data.avatarImage, data.isTeacher, data.inventory, data.currentBg, data.currentCharacter, courseProgressMap, lessonProgressMap, chapterFinishedMap, data.unlockedInventory, data.unlockedRewards, data.debug, data.lessonPlan, data.serverId, data.schoolId, data.sectionId, data.studentId, data.schoolName, data.sectionName, data.currentReward, last5Lessons);
      ...
      User.toJson = function(user) {
        ...
        var las5LessonMapObj = {};
        user._last5Lessons.forEach(function(lp, id) {
  ...
  "util-logger": [ function(require, module, exports) {
    ...
    var HISTORICAL_PROGRESS_METHOD_SIGNATURE = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V";
    ...
    var UtilLogger = function() {
      ...
      UtilLogger.historyProgress = function(chapterId, chapterName, lessonId, lessonName, progressId, school, section, subjectCode, score, assignmentId, name, timeSpent) {
        cc.log("historyProgress for: " + chapterId + "-" + chapterName + "-" + lessonId + "-" + progressId);
        try {
          if (cc.sys.isNative && cc.sys.os == cc.sys.OS_ANDROID) return jsb.reflection.callStaticMethod(LOGGER_CLASS, HISTORICAL_PROGRESS_METHOD, HISTORICAL_PROGRESS_METHOD_SIGNATURE, chapterId, chapterName, lessonId, lessonName, progressId, school, section, subjectCode, score, assignmentId, name, timeSpent);
        } catch (e) {}
      };
      UtilLogger.syncProfile = function(schoolId, sectionId, studentId, profile, progressId) {
        ...
        cc.log("syncProfile in util-logger: mode ", parseInt(profile_1.default.getValue(profile_1.CURRENTMODE)), constants_1.Mode.HomeConnect);
        try {
          var mode = parseInt(profile_1.default.getValue(profile_1.CURRENTMODE));
          console.log("syncProfile in util-logger bool ", mode === constants_1.Mode.School, mode === constants_1.Mode.HomeConnect, cc.sys.isNative, cc.sys.os == cc.sys.OS_ANDROID, (mode === constants_1.Mode.School || mode === constants_1.Mode.HomeConnect) && cc.sys.isNative && cc.sys.os == cc.sys.OS_ANDROID);
          if ((mode === constants_1.Mode.School || mode === constants_1.Mode.HomeConnect) && cc.sys.isNative && cc.sys.os == cc.sys.OS_ANDROID) {
            cc.log("syncProfile in util-logger: mode in if ", schoolId, sectionId, studentId, profile, progressId);
            return jsb.reflection.callStaticMethod(LOGGER_CLASS, SYNC_PROFILE_METHOD, SYNC_PROFILE_METHOD_SIGNATURE, schoolId, sectionId, studentId, profile, progressId);
          }
        } catch (e) {
      ...
      UtilLogger.processNewLinkStudent = function(customAuthInfo, otpCode) {
        var _a, _b;
        var firebaseUser = customAuthInfo.student;
        var student = {
        ...
        var studentJson = UtilLogger.fetchStudentById(student.firebaseId);
        cc.log("Student Json ", studentJson);
        var profileExists = !!(null === student || void 0 === student ? void 0 : student.profileInfo);
        var user = null;
        if (profileExists && (null === (_a = null === student || void 0 === student ? void 0 : student.profileInfo) || void 0 === _a ? void 0 : _a.lessonProgressMap) && (null === (_b = null === student || void 0 === student ? void 0 : student.profileInfo) || void 0 === _b ? void 0 : _b.courseProgressMap)) {
          cc.log("Student Profile exists:" + student.profileInfo);
          user = profile_1.User.fromJson(JSON.stringify(student.profileInfo));
          var currentuser = profile_1.User.getCurrentUser();
          null == user || !currentuser || !(null === currentuser || void 0 === currentuser ? void 0 : currentuser.lessonProgressMap) || UtilLogger.mergeUser(currentuser, user);
        ...
        !customAuthInfo.progressId ? "" : profile_1.User.replaceUserID(user.id, customAuthInfo.progressId);
        user.id = !customAuthInfo.progressId ? user.id : customAuthInfo.progressId;
        cc.log("schoolId ", student.schoolId);
        cc.sys.localStorage.setItem(constants_1.FIREBASE_SCHOOL_ID, student.schoolId);
        cc.sys.localStorage.setItem(constants_1.FIREBASE_SECTION_ID, student.sectionId);
        cc.sys.localStorage.setItem(constants_1.FIREBASE_STUDENT_ID, customAuthInfo.studentId);
        console.log("setCurrentUser userid..");
        profile_1.User.setCurrentUser(user);
        console.log("storeUser userid..");
        user.storeUser();
        cc.log("synced profile", profile_1.User.getCurrentUser().isConnected, profile_1.User.getCurrentUser().courseProgressMap);
        var request = {
      ...
      UtilLogger.processLoginFail = function() {
        var mode = parseInt(profile_1.default.getValue(profile_1.CURRENTMODE));
        cc.log("processLoginFail...");
        if (mode == constants_1.Mode.HomeConnect) {
          var currentUser = profile_1.User.getCurrentUser();
          if (!!currentUser) {
            cc.log("processLoginFail... current User", profile_1.User.toJson(currentUser));
            currentUser.isConnected = false;
            currentUser.storeUser();
          }
          profile_1.User.getUsers().forEach(function(user) {
            var schoolId = cc.sys.localStorage.getItem("SCHOOL_USER");
            if ((null === user || void 0 === user ? void 0 : user.schoolId) === schoolId) {
              user.isConnected = false;
              user.storeUser();
            }
          });
      ...
      UtilLogger.mergeUser = function(fromUser, toUser) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p;
        console.log("mergeing user");
        if (!fromUser || !toUser) return toUser;
        !fromUser.lessonProgressMap || (toUser.lessonProgressMap ? fromUser.lessonProgressMap.forEach(function(v, key) {
          var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m;
          var score = null !== (_b = null === (_a = fromUser.lessonProgressMap.get(key)) || void 0 === _a ? void 0 : _a.score) && void 0 !== _b ? _b : 0;
          var _course = null === (_c = fromUser.lessonProgressMap.get(key)) || void 0 === _c ? void 0 : _c.course;
          toUser.lessonProgressMap.has(key) && toUser.lessonProgressMap.get(key).score > score && (score = toUser.lessonProgressMap.get(key).score);
          var fromAssignments = null !== (_e = null === (_d = fromUser.lessonProgressMap.get(key)) || void 0 === _d ? void 0 : _d.assignmentIds) && void 0 !== _e ? _e : [];
          var toAssignments = null !== (_g = null === (_f = toUser.lessonProgressMap.get(key)) || void 0 === _f ? void 0 : _f.assignmentIds) && void 0 !== _g ? _g : [];
          var _assignments = fromAssignments.concat(toAssignments.filter(function(item) {
            return fromAssignments.indexOf(item) < 0;
          }));
          var _date = null === (_h = fromUser.lessonProgressMap.get(key)) || void 0 === _h ? void 0 : _h.date;
          var fromUserAttempts = null !== (_k = null === (_j = fromUser.lessonProgressMap.get(key)) || void 0 === _j ? void 0 : _j.attempts) && void 0 !== _k ? _k : 0;
          var toUserAttempts = null !== (_m = null === (_l = toUser.lessonProgressMap.get(key)) || void 0 === _l ? void 0 : _l.attempts) && void 0 !== _m ? _m : 0;
          var attempts = toUserAttempts >= fromUserAttempts ? toUserAttempts : fromUserAttempts;
          toUser.lessonProgressMap.set(key, new profile_1.LessonProgressClass(score, attempts, _course, _assignments.toString(), _date));
        }) : toUser.lessonProgressMap = fromUser.lessonProgressMap);
        toUser.courseProgressMap || (toUser.courseProgressMap = fromUser.courseProgressMap);
        var unlockedRewards = __assign(__assign({}, null !== (_a = toUser.unlockedRewards) && void 0 !== _a ? _a : {}), null !== (_b = fromUser.unlockedRewards) && void 0 !== _b ? _b : {});
        var unlockedInventory = __assign(__assign({}, null !== (_c = toUser.unlockedInventory) && void 0 !== _c ? _c : {}), null !== (_d = fromUser.unlockedInventory) && void 0 !== _d ? _d : {});
        var currentReward = null !== (_g = null === (_e = toUser.currentReward) || void 0 === _e ? void 0 : _e.concat(null === (_f = fromUser.currentReward) || void 0 === _f ? void 0 : _f.filter(function(item) {
          var _a;
          return (null === (_a = toUser.currentReward) || void 0 === _a ? void 0 : _a.indexOf(item)) < 0;
        }))) && void 0 !== _g ? _g : [];
        var assignments = null !== (_k = null === (_h = toUser.assignments) || void 0 === _h ? void 0 : _h.concat(null === (_j = fromUser.assignments) || void 0 === _j ? void 0 : _j.filter(function(item) {
          var _a;
          return (null === (_a = toUser.assignments) || void 0 === _a ? void 0 : _a.indexOf(item)) < 0;
        }))) && void 0 !== _k ? _k : [];
        var inventory = __assign(__assign({}, null !== (_l = toUser.inventory) && void 0 !== _l ? _l : {}), null !== (_m = fromUser.inventory) && void 0 !== _m ? _m : {});
        var last5Lessons = new Map(__spreadArrays(Array.from(null === (_o = fromUser.last5Lessons) || void 0 === _o ? void 0 : _o.entries()), Array.from(null === (_p = toUser.last5Lessons) || void 0 === _p ? void 0 : _p.entries())));
  ...
  util: [ function(require, module, exports) {
    ...
    exports.Util = exports.TouchEvents = exports.SUBPACKAGES = exports.STICKER_REWARDS = exports.STICKER_BOOK = exports.NUMBER_NAME = exports.REWARD_BACKGROUNDS = exports.REWARD_CHARACTERS = exports.REWARD_TYPES = exports.INVENTORY_ICONS = exports.INVENTORY_ANIMATIONS = exports.INVENTORY_SAVE_CONSTANTS = exports.INVENTORY_DATA = void 0;
    var chimple_label_1 = require("./chimple-label");
    ...
    exports.STICKER_BOOK = [ "rewardsticker0000", "rewardsticker0001", "rewardsticker0002", "rewardsticker0003", "rewardsticker0004", "rewardsticker0005", "rewardsticker0006", "rewardsticker0007", "rewardsticker0008", "rewardsticker0009" ];
    exports.STICKER_REWARDS = [ [ "icecreamset_part1", "icecreamset_part2", "icecreamset_part3", "icecreamset_part4", "icecreamset_part5", "icecreamset_part6" ], [ "bulldozer_part1", "bulldozer_part2", "bulldozer_part3", "bulldozer_part4", "bulldozer_part5", "bulldozer_part6" ], [ "astronaut_part1", "astronaut_part2", "astronaut_part3", "astronaut_part4", "astronaut_part5", "astronaut_part6" ], [ "house_part1", "house_part2", "house_part3", "house_part4", "house_part5", "house_part6" ], [ "rocket_part1", "rocket_part2", "rocket_part3", "rocket_part4", "rocket_part5", "rocket_part6" ], [ "taxi_part1", "taxi_part2", "taxi_part3", "taxi_part4", "taxi_part5", "taxi_part6" ], [ "frock_part1", "frock_part2", "frock_part3", "frock_part4", "frock_part5", "frock_part6" ], [ "guitar_part1", "guitar_part2", "guitar_part3", "guitar_part4", "guitar_part5", "guitar_part6" ], [ "seasonset_part1", "seasonset_part2", "seasonset_part3", "seasonset_part4", "seasonset_part5", "seasonset_part6" ], [ "shirt_part1", "shirt_part2", "shirt_part3", "shirt_part4", "shirt_part5", "shirt_part6" ] ];
    ...
    var Util = function() {
      ...
      Util.load = function(res, callback, needsRelease) {
        ...
        "mp3" === ext || "m4a" === ext ? bundle.load(resName, cc.AudioClip, function(err, asset) {
          ...
          err && cc.log(JSON.stringify(err));
          callback(err, asset);
        }) : Util.isValidURL(res) ? cc.assetManager.loadRemote("" + res, function(err, clip) {
          clip && !err && callback(err, clip);
      ...
      Util.showHelp = function(from, to, callBack, playAudio, showHelpHand) {
        void 0 === callBack && (callBack = null);
        void 0 === playAudio && (playAudio = true);
        void 0 === showHelpHand && (showHelpHand = false);
        var config = config_1.default.getInstance();
        var lessonNode = cc.Canvas.instance.node;
        playAudio && lessonController_1.default.friend.speakHelp();
        1 != config.problem && !showHelpHand || null == from || null == to ? null != callBack && callBack() : cc.resources.load("prefabs/help", function(err, prefab) {
      ...
      Util.loadFriend = function(callback, char) {
        void 0 === char && (char = null);
        if (null == char) {
          var user = profile_1.User.getCurrentUser();
      ...
      Util.equipAcc = function(friendNode) {
        ...
        exports.INVENTORY_SAVE_CONSTANTS.forEach(function(key) {
          ...
          if (void 0 != newHatName && !!_armature) {
      ...
      Util.setBackground = function(bgprefabName, node) {
      ...
      Util.changeHotUpdateServer = function(serverUrl) {
        try {
          if (!cc.sys.isNative) return;
          var fullStoragePath = (jsb.fileUtils ? jsb.fileUtils.getWritablePath() : "/") + "HotUpdateSearchPaths/project.manifest";
          var manifestExists = jsb.fileUtils.isFileExist(fullStoragePath);
          cc.log("manifestExists", manifestExists, "serverUrl", serverUrl);
          if (!manifestExists) {
            profile_1.default.setValue(constants_1.CUSTOM_HOT_UPDATE_SERVER, serverUrl);
            return;
          }
          var stringFile = jsb.fileUtils.getStringFromFile(fullStoragePath);
          cc.log("manifest stringFile", stringFile);
          var manifestJson = JSON.parse(stringFile);
          ...
          var success = jsb.fileUtils.writeStringToFile(JSON.stringify(manifestJson), fullStoragePath);
          cc.log("written is success", success);
          success && profile_1.default.setValue(constants_1.CUSTOM_HOT_UPDATE_SERVER, serverUrl);
        } catch (error) {
          console.log("error on changeHotUpdateServer", error);
        }
      };
      Util.getCurrentHotUpdateVersion = function() {
        var version = profile_1.default.getItem(constants_1.ASSET_MANIFEST_VERSION);
        if (cc.sys.isNative) {
          var fullStoragePath = (jsb.fileUtils ? jsb.fileUtils.getWritablePath() : "/") + "HotUpdateSearchPaths/project.manifest";
          var manifestExists = jsb.fileUtils.isFileExist(fullStoragePath);
          if (manifestExists) {
