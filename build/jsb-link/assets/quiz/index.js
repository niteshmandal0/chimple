  ...
  compare_number_magnitudes: [ function(require, module, exports) {
    ...
    var CompareNumberMagnitudes = function(_super) {
      ...
      CompareNumberMagnitudes.prototype.renderDropPanel = function() {
        ...
        math_drag_1.default.helpToDragNode = dropPanel;
  ...
  "math-drag": [ function(require, module, exports) {
    ...
    var MathDrag = function(_super) {
      ...
      MathDrag.prototype.onTouchEnd = function(touch) {
        ...
        this.match || MathDrag_1.dragWrongMovesCount++;
        MathDrag_1.helpToDragNode && MathDrag_1.dragWrongMovesCount >= 2 && this.scheduleOnce(function() {
          console.log("showing help hand ", MathDrag_1.helpToDragNode.name);
          util_1.Util.showHelp(_this.node, MathDrag_1.helpToDragNode, null, true, true);
        }, .5);
      };
      ...
      var MathDrag_1;
      MathDrag.helpToDragNode = null;
      MathDrag.dragWrongMovesCount = 0;
      MathDrag = MathDrag_1 = __decorate([ ccclass ], MathDrag);
      return MathDrag;
    }(drag_1.default);
  ...
  "math-drop": [ function(require, module, exports) {
    ...
    var MathDrop = function(_super) {
      ...
      MathDrop.prototype.onCollisionEnter = function(other, self) {
        math_drag_1.default.dragWrongMovesCount = 0;
  ...
  missing_number: [ function(require, module, exports) {
    ...
    var MissingNumber = function(_super) {
      ...
      MissingNumber.prototype.renderDropPanel = function() {
        ...
        math_drag_1.default.helpToDragNode = missingPanel;
      ...
      QuizMaths.prototype.onLoad = function() {
        ...
        switch (this._mathsConfig.type) {
         ...
         case exports.WORD_PROBLEM:
          ...
          wordProblemComponent.assetDir = constants_1.ASSET_URL + "/" + lang + "-help-remote/questionboard";
